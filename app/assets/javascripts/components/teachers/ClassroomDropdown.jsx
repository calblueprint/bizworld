/**
 * @prop onChange - callback for filter change
 */
  ...
  render() {
    ...
    return (
      <fieldset className="input-container program-select">
        ...
        <select
          name="program_id"
          className="form-control program-select"
...
ClassroomDropdown.propTypes = { onChange: React.PropTypes.func.isRequired };
    ...
    return (
      <div className="classroom-card-col">
        ...
        <div
          ...
          id="newClassroomModal"
          tabIndex={-1}
          role="dialog"
          aria-labelledby="newClassroomModalLabel"
        >
