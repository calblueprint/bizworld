  ...
  _renderInput(name, label, type, placeholder, focus = false) {
    return (
      <div className="input-container">
        ...
        <input
          onChange={this._handleChange} name={name}
    ...
    return (
      <div>
        <div className="login-title">
          <span className="fa fa-angle-left back" onClick={this._updateView}></span>
          <h1>New Account</h1>
        </div>
        <form>
          ...
          <div className="input-container city-state-picker">
            <div className="item city">
              ...
              <input
                name="city" type="text" placeholder="San Francisco"
          ...
          <input
            name="submit" type="button" value="Create Account"
