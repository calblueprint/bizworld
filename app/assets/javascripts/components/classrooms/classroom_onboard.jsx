  ...
  render() {
    return (
      <div className="onboarding-container">
        ...
        <div
          className="modal fade" id="onboarding-modal" tabIndex={-1}
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <div className="onboarding-pic-container">
                  <img role="presentation" src="/assets/onboarding.png" />
                </div>
                <h1>Thanks for joining us!</h1>
                <p>
                  You'll be using this page to manage all your students. To take a quick tour of
                  all the features, click "Begin Tour" below. We're glad you've joined the Bizworld
                  family!
                </p>
              </div>
              <div className="modal-footer">
                ...
                >Not now</button>
                <button
                  type="button" name="begin"
                  value="Begin Tour" className="submit-button"
                  onClick={this._startTourist}
                >Begin Tour</button>
              </div>
            </div>
          </div>
