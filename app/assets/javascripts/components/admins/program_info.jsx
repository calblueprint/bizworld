...
class ProgramInfo extends DefaultForm {
  ...
  _attemptSave = (e) => {
    const success = (msg) => {
      program = React.addons.update(this.state.program,
  ...
  render() {
    deactivate_button_value = this.state.program.is_active ?
      "Deactivate Program" : "Activate Program";
      ...
      <div className="class-info-container">
        ...
        <div className="class-info-box">
          ...
          <div className="button-container">
            <input
              name="deactivate" type="button" value={deactivate_button_value}
